<?php
/**
 * following.php — Feed filtered to accounts the logged-in user follows.
 * Lives at: /project/filter/following.php
 */
...
try {
    $stmt2 = $myPDO->query('SELECT * FROM users ORDER BY user_id');
} catch (PDOException $e) {
